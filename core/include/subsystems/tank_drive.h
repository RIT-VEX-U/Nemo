...
public:
   ...
   */
  bool drive_forward(double inches, directionType dir, Feedback &feedback, double max_speed=1, double end_vel=0);
   ...
   * @param end_vel     the movement profile will attempt to reach this velocity by its completion
   */
  bool drive_forward(double inches, directionType dir, double max_speed=1, double end_vel=0);
   ...
   * @param max_speed   the maximum percentage of robot speed at which the robot will travel. 1 = full power
   */
  bool turn_degrees(double degrees, Feedback &feedback, double max_speed=1, double end_vel=0);
   ...
   * @param end_vel     the movement profile will attempt to reach this velocity by its completion
   */  
  bool turn_degrees(double degrees, double max_speed=1, double end_vel=0);
   ...
   * @param end_vel    the movement profile will attempt to reach this velocity by its completion
   */
  bool drive_to_point(double x, double y, vex::directionType dir, Feedback &feedback, double max_speed=1, double end_vel=0);
   ...
   * @param end_vel    the movement profile will attempt to reach this velocity by its completion
   */
  bool drive_to_point(double x, double y, vex::directionType dir, double max_speed=1, double end_vel=0);
   ...
   * @param end_vel     the movement profile will attempt to reach this velocity by its completion
   */
  bool turn_to_heading(double heading_deg, Feedback &feedback, double max_speed=1, double end_vel=0);
  /**
   * Turn the robot in place to an exact heading relative to the field.
   ...
   * @param end_vel     the movement profile will attempt to reach this velocity by its completion
   */
  bool turn_to_heading(double heading_deg, double max_speed=1, double end_vel=0);
